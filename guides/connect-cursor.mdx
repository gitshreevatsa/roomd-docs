...
**Same repo, new chat:** that chat also gets roomd tools from project MCP, but it joins your room only if it uses the same `room_id`. Details: [Rooms, chats, and agent ids](/guides/rooms-and-chats).
