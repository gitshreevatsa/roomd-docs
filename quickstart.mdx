---
title: "Quickstart · connect agents to roomd"
description: "Get each engineer's Claude Code or Cursor agent into the same roomd room over MCP in a few minutes."
